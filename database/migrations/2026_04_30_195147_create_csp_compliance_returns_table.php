<?php
// database/migrations/2024_xxxx_create_csp_compliance_returns_table.php
...
return new class extends Migration
{
    public function up()
    {
        Schema::create('csp_compliance_returns', function (Blueprint $table) {
            $table->id();
            ...
            $table->json('money_transfer')->nullable();
    ...
    {
        Schema::dropIfExists('csp_compliance_returns');
    }
};
