...
class Kernel extends HttpKernel
{
    ...
    protected $middlewareGroups = [
        'web' => [
            ...
            \App\Http\Middleware\IncreasePhpLimits::class,
        ],
    ...
    'account.manager' => \App\Http\Middleware\AccountManagerMiddleware::class,
    'company.profile' => \App\Http\Middleware\CompanyProfile::class,
