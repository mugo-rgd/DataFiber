...
<div class="container">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap gap-2">
        <div>
            <h4 class="mb-0">
                <i class="fas fa-server me-2 text-primary"></i> ASP Compliance Preview
            </h4>
    ...
    <div class="card shadow-sm mb-3">
        <div class="card-body">
            <div class="d-flex flex-wrap gap-2">
                ...
                <!-- PRINT / DOWNLOAD PDF -->
                <a href="{{ route('asp.print', $record->id) }}" target="_blank" class="btn btn-primary">
    ...
    <div class="card shadow-sm">
        <div class="card-header bg-white d-flex justify-content-between align-items-center">
            <strong><i class="fas fa-database me-1 text-primary"></i> Captured Form Data</strong>
