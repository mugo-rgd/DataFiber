...
@section('title', 'Kenya Fibre Dashboard - Dark Fibre CRM')
@section('page-title', 'Kenya Fibre Network Dashboard')
        ...
        <div class="card">
            ...
            <div class="card-body p-0">
                <div class="networks-container" id="networkList" style="max-height: 600px; overflow-y: auto;">
                    @forelse($networkPaths ?? [] as $network)
                    <div class="network-row p-3 border-bottom"
                        ...
                        <div class="d-flex justify-content-between align-items-start">
                            ...
                            <div class="text-end">
                                <span class="fiber-status-badge status-{{ strtolower($network['status'] ?? 'active') }} mb-2">
                                ...
                                <div class="mt-2">
                                    ...
                                    @endphp
                                    <span class="badge link-type-{{ $linkTypeClass }}">
                                        {{ $linkType }}
                                    </span>
                                </div>
                            </div>
            ...
            <div class="card-footer bg-white text-center p-2">
                <small class="text-muted">
                    Showing {{ count($networkPaths ?? []) }} networks • Click any row to focus on map
                </small>
            </div>
        </div>
    </div>
...
const networkPaths = @json($networkPaths ?? []);
