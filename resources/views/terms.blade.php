        ...
        <div class="col-lg-10">
            ...
            <div class="card shadow-sm border-0 mb-4">
                <div class="card-body p-4 p-lg-5">
                    <!-- Introduction -->
                    <section class="mb-5">
                        <h2 class="h4 mb-3 text-kp-blue">1. Introduction</h2>
                    ...
                    <!-- Account Terms -->
                    <section class="mb-5">
                        <h2 class="h4 mb-3 text-kp-blue">2. Account Terms</h2>
                        <div class="ms-3">
                    ...
                    <!-- Service Usage -->
                    <section class="mb-5">
                        <h2 class="h4 mb-3 text-kp-blue">3. Acceptable Use</h2>
                    ...
                    <!-- Data and Privacy -->
                    <section class="mb-5">
                        <h2 class="h4 mb-3 text-kp-blue">4. Data and Privacy</h2>
                    ...
                    <section class="mb-5">
                        <h2 class="h4 mb-3 text-kp-blue">5. Intellectual Property</h2>
                    ...
                    <!-- Termination -->
                    <section class="mb-5">
                        <h2 class="h4 mb-3 text-kp-blue">6. Termination</h2>
                    ...
                    <!-- Disclaimer -->
                    <section class="mb-5">
                        <h2 class="h4 mb-3 text-kp-blue">7. Disclaimer</h2>
                    ...
                    <section class="mb-5">
                        <h2 class="h4 mb-3 text-kp-blue">8. Limitation of Liability</h2>
                    ...
                    <!-- Changes to Terms -->
                    <section class="mb-5">
                        <h2 class="h4 mb-3 text-kp-blue">9. Changes to Terms</h2>
                    ...
                    <!-- Contact Information -->
                    <section class="mb-4">
                        <h2 class="h4 mb-3 text-kp-blue">10. Contact Us</h2>
                        <p>If you have any questions about these Terms, please contact us:</p>
                        <ul class="list-unstyled">
                            <li><i class="fas fa-envelope me-2 text-kp-blue"></i> legal@darkfibre-crm.test</li>
                            <li><i class="fas fa-phone me-2 text-kp-blue"></i> +254 700 000 000</li>
                            <li><i class="fas fa-map-marker-alt me-2 text-kp-blue"></i> Nairobi, Kenya</li>
                        </ul>
                    </section>
                </div>
            </div>
            ...
            <div class="card border-kp-blue">
                <div class="card-body text-center p-4">
                    <h3 class="h5 mb-3 text-kp-blue">Acceptance of Terms</h3>
