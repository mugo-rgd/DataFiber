                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 fw-bold text-gray-800">{{ $quotations->total() }}</div>
                        </div>
                        <div class="col-auto">
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 fw-bold text-gray-800">{{ $quotations->where('status', 'draft')->count() }}</div>
                        </div>
                        <div class="col-auto">
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 fw-bold text-gray-800">{{ $quotations->where('status', 'approved')->count() }}</div>
                        </div>
                        <div class="col-auto">
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 fw-bold text-gray-800">{{ $quotations->where('status', 'sent')->count() }}</div>
                        </div>
                        <div class="col-auto">
                    ...
                    <table class="table table-hover mb-0">
                        ...
                        <tbody>
                            @foreach($quotations as $quotation)
                                @include('admin.quotations.partials.quotation-row', ['quotation' => $quotation, 'isAdmin' => $isAdmin])
                            @endforeach
