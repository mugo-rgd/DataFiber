...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <div>
        ...
        @if($return->status === 'draft')
            <a href="{{ route('csp.edit', $return->id) }}" class="btn btn-warning">
    ...
    <div class="col-md-4">
        ...
        <div class="card mb-3">
            ...
            <div class="card-body">
                ...
                <button class="btn btn-sm btn-outline-primary" type="button" data-bs-toggle="collapse" data-bs-target="#servicesList">
                    View Services
                </button>
