        ...
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                <h1 class="h3 text-gray-800">
                    <i class="fas fa-headset text-kp-blue"></i> Helpdesk Tickets
                </h1>
                            ...
                            <table class="table table-striped table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="#" class="btn btn-sm btn-outline-kp-primary">
                ...
                <div class="card-body">
                    <div class="list-group">
                        <a href="#" class="list-group-item list-group-item-action">
                            <i class="fas fa-plus text-kp-blue"></i> Create New Ticket
                        </a>
                        <a href="#" class="list-group-item list-group-item-action">
                            <i class="fas fa-filter text-kp-yellow"></i> Filter by Priority
                        </a>
                        <a href="#" class="list-group-item list-group-item-action">
                            <i class="fas fa-download text-kp-green"></i> Export Tickets
                        </a>
                        <a href="#" class="list-group-item list-group-item-action">
