        ...
        <div class="col-md-10">
            ...
            <div class="card">
                <div class="card-header bg-kp-blue text-white d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        @if($quotation->status === 'sent')
                            <span class="badge bg-kp-yellow">Awaiting Customer Review</span>
                        @elseif($quotation->status === 'customer_approved')
                            <span class="badge bg-warning">Awaiting Final Approval</span>
                        @elseif($quotation->status === 'approved')
                            <span class="badge bg-kp-green">Approved</span>
                        @elseif($quotation->status === 'customer_rejected' || $quotation->status === 'rejected')
                ...
                <div class="card-body">
                    <div class="row mb-4">
                        <div class="col-md-6">
                            <h5 class="text-kp-blue mb-3">Design Request Information</h5>

                            @if($quotation->designRequest)
                                <div class="mb-3">
                                    <label class="text-muted small mb-1">Request Number:</label>
                                    <p class="fw-bold">
                                        {{ $quotation->designRequest->request_number ?? 'N/A' }}
                                    </p>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <p class="text-muted">
                                        {{ $quotation->designRequest->description }}
                                    </p>
                                </div>
                            @else
                                <div class="alert alert-warning">
                                    <i class="fas fa-exclamation-triangle me-2"></i>
                                    No design request associated
                                </div>
                            @endif
                        </div>

                        <div class="col-md-6">
                            <h5 class="text-kp-blue mb-3">Quotation Details</h5>
                            ...
                            <div class="mb-3">
                                ...
                                @if($quotation->customer_approval_status === 'approved')
                                    <span class="badge bg-kp-green">Accepted</span>
                            ...
                            <div class="mb-3">
                                ...
                                <p class="fw-bold {{ $quotation->valid_until < now() ? 'text-danger' : 'text-kp-green' }}">
                            ...
                            @if($quotation->customer_approved_at)
                                <div class="mb-3">
                                    <label class="text-muted small mb-1">Accepted Date:</label>

                                    <p class="text-kp-green">
                    ...
                    <div class="row mb-4">
                        <div class="col-md-12">
                            <h5 class="text-kp-blue mb-3">Financial Summary</h5>
                    ...
                    @if($quotation->scope_of_work)
                        <div class="mb-4">
                            <h5 class="text-kp-blue mb-3">Scope of Work</h5>
                    ...
                    @if($quotation->customer_notes)
                        <div class="mb-4">
                            <h5 class="text-kp-blue mb-3">Additional Notes</h5>
                            <div class="border rounded p-4 bg-light">
                                <div style="white-space: pre-line;">
                ...
                <div class="card mt-4">
                    ...
                    <div class="card-body">
                        <div class="alert alert-info">
                            ...
                            By accepting this quotation, you confirm that you accept all terms, pricing, and timeline outlined above.
                            It will then be submitted for final approval.
                        </div>

                        <div class="d-flex justify-content-start">
                            <form action="{{ route('customer.quotations.approve', $quotation) }}"
                                  method="POST"
                                  class="quotation-action-form d-inline me-3">
                                @csrf
                                @method('PATCH')

                                <button type="submit"
                                        class="btn btn-kp-success btn-lg action-submit-btn"
                            ...
                            <form action="{{ route('customer.quotations.reject', $quotation) }}"
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="form-text">
                                            This information will be shared with our team.
                                        </div>
                                    </div>
                                </div>
            ...
            @elseif($quotation->customer_approval_status === 'approved')
                <div class="alert alert-kp-success mt-4">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <h5 class="alert-heading mb-1">Quotation Accepted</h5>
                            <p class="mb-0">
                                You accepted this quotation on
                                {{ $quotation->customer_approved_at ? $quotation->customer_approved_at->format('F j, Y \a\t g:i A') : 'an unspecified date' }}.
                                It is now awaiting final approval.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="alert alert-danger mt-4">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <p class="mb-0">
                                You rejected this quotation on
                                {{ $quotation->customer_rejected_at->format('F j, Y \a\t g:i A') }}.
                            </p>

                            @if($quotation->rejection_reason)
                                <p class="mb-0 mt-2">
                                    <strong>Reason Provided:</strong> {{ $quotation->rejection_reason }}
                                </p>
                            @endif
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            @if($quotation->accountManager)
                                <p class="mb-1">
                                    <strong>{{ $quotation->accountManager->name }}</strong>
                                </p>

                                <p class="text-muted small mb-0">
                                    {{ $quotation->accountManager->email }}
                                </p>

                                @if($quotation->accountManager->phone)
                                    <p class="text-muted small mb-0">
                                        {{ $quotation->accountManager->phone }}
                                    </p>
                                @endif
                            @else
                        ...
                        <div class="col-md-6">
                            ...
                            <p class="mb-1">
                                ...
                                {{ $quotation->created_at->format('F j, Y \a\t g:i A') }}
                            </p>

                            <p class="mb-0">
                                <strong>Last Updated:</strong>
                                {{ $quotation->updated_at->format('F j, Y \a\t g:i A') }}
                            </p>
                        </div>
                    </div>
                </div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    document.querySelectorAll('.quotation-action-form').forEach(function (form) {
        form.addEventListener('submit', function (event) {
            ...
            if (textarea) {
                const confirmed = confirm('Are you sure you want to reject this quotation? This action cannot be undone.');
