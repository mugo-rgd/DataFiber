...
<div class="modal fade" id="approveQuotationModal" tabindex="-1" aria-labelledby="approveModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="alert alert-info">
                    ...
                    Are you sure you want to approve this quotation? Once approved, it can be sent to the customer.
                </div>
          ...
          maxlength="500"
          oninput="document.getElementById('approveNotesCounter').textContent = this.value.length"></textarea>
                ...
                <div class="alert alert-warning">
                    ...
                    This action cannot be undone. The quotation status will change to "Approved".
                </div>
            </div>
    ...
    <button type="button"
            ...
            id="approveSubmitBtn"
            onclick="quotationApprove(this); return false;">
...
<?php /**PATH G:\project\darkfibre-crm\resources\views/admin/quotations/modals/approve-modal.blade.php ENDPATH**/ ?>