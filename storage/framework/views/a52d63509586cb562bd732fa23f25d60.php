    ...
    <div class="row">
        ...
        <div class="col-md-4 col-lg-3">
            <div class="card">
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="avatar me-3">
                                        <div class="bg-primary rounded-circle text-white d-flex align-items-center justify-content-center"
                                           ...
                                           <?php echo e(substr($userName, 0, 1)); ?>

                                        </div>
                                    </div>
                                    <div>
                                        <h6 class="mb-0"><?php echo e($userName); ?></h6>
                                        <small class="text-muted">
                                            <?php if($conversation->lastMessage): ?>
                                                <?php if($conversation->lastMessage->type === 'file'): ?>
                                                    📎 <?php echo e(Str::limit($conversation->lastMessage->file_name, 30)); ?>
                                        ...
                                        <br>
                                        <small class="text-muted"><?php echo e($userRole); ?></small>
                                    </div>
                                </div>
                ...
                <?php if(isset($conversations) && method_exists($conversations, 'links')): ?>
