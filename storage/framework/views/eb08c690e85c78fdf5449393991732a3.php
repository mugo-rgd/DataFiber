<div class="modal fade" id="sendQuotationModal" tabindex="-1" aria-labelledby="sendModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="alert alert-info">
                    ...
                    This will send the quotation to the customer's email address.
                </div>
          ...
          maxlength="500"
          oninput="document.getElementById('sendNotesCounter').textContent = this.value.length"></textarea>
                ...
                <div class="alert alert-warning">
                    ...
                    Once sent, the quotation status will change to "Sent" and the customer will be notified.
                </div>
            </div>
    ...
    <button type="button"
            class="btn btn-info"
            id="sendSubmitBtn"
            onclick="quotationSend(this); return false;">
...
<?php /**PATH G:\project\darkfibre-crm\resources\views/admin/quotations/modals/send-modal.blade.php ENDPATH**/ ?>