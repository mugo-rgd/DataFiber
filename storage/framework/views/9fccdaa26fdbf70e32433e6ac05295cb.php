                ...
                <ul class="navbar-nav me-auto">
                    <?php if(auth()->guard()->check()): ?>
                        ...
                        <?php if(in_array(Auth::user()->role, ['admin', 'technical_admin', 'system_admin', 'accountmanager_admin']) && Route::has('admin.dashboard')): ?>
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo e(route('admin.dashboard')); ?>" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Admin Dashboard">
                        ...
                        <?php if(Auth::user()->role === 'customer' && Route::has('customer.customer-dashboard')): ?>
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo e(route('customer.customer-dashboard')); ?>" data-bs-toggle="tooltip" data-bs-placement="bottom" title="My Dashboard">
                                    <i class="fas fa-tachometer-alt"></i>
                                    <span class="nav-text">Dashboard</span>
                                </a>
                            </li>
                        ...
                        <?php if(Auth::user()->role === 'designer' && Route::has('designer.dashboard')): ?>
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo e(route('designer.dashboard')); ?>" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Designer Dashboard">
                        ...
                        <?php if(Auth::user()->role === 'surveyor' && Route::has('surveyor.dashboard')): ?>
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo e(route('surveyor.dashboard')); ?>" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Surveyor Dashboard">
                        ...
                        <?php if(Auth::user()->role === 'technician' && Route::has('technician.dashboard')): ?>
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo e(route('technician.dashboard')); ?>" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Technician Dashboard">
                        ...
                        <?php if(Auth::user()->role === 'ict_engineer' && Route::has('ictengineer.dashboard')): ?>
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo e(route('ictengineer.dashboard')); ?>" data-bs-toggle="tooltip" data-bs-placement="bottom" title="ICT Engineer Dashboard">
                        ...
                        <?php if(Auth::user()->role === 'account_manager' && Route::has('account-manager.dashboard')): ?>
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo e(route('account-manager.dashboard')); ?>" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Account Manager Dashboard">
                        ...
                        <?php if(Auth::user()->role === 'debt_manager' && Route::has('finance.debt.dashboard')): ?>
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo e(route('finance.debt.dashboard')); ?>" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Debt Manager Dashboard">
                                    <i class="fas fa-chart-line"></i>
                            ...
                            <div class="dropdown-menu">
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('isTechnician')): ?>
                                    <?php if(Route::has('technician.dashboard')): ?>
                                        <a class="dropdown-item" href="<?php echo e(route('technician.dashboard')); ?>"><i class="fas fa-tachometer-alt me-2"></i> My Dashboard</a>
                                    <?php endif; ?>
                                    <?php if(Route::has('technician.work-orders.index')): ?>
                                        <a class="dropdown-item" href="<?php echo e(route('technician.work-orders.index')); ?>"><i class="fas fa-clipboard-list me-2"></i> My Work Orders</a>
                                    <?php endif; ?>
                                    <?php if(Route::has('technician.equipment.index')): ?>
                                        <a class="dropdown-item" href="<?php echo e(route('technician.equipment.index')); ?>"><i class="fas fa-toolbox me-2"></i> Equipment</a>
                                    <?php endif; ?>
                                    <div class="dropdown-divider"></div>
                                <?php endif; ?>
                                <?php if(Route::has('maintenance.dashboard')): ?>
                                    <a class="dropdown-item" href="<?php echo e(route('maintenance.dashboard')); ?>"><i class="fas fa-tachometer-alt me-2"></i> Maint Dashboard</a>
                                <?php endif; ?>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create-maintenance-request')): ?>
                                    <?php if(Route::has('maintenance.requests.create')): ?>
                                        <a class="dropdown-item" href="<?php echo e(route('maintenance.requests.create')); ?>"><i class="fas fa-plus-circle me-2"></i> New Request</a>
                                    <?php endif; ?>
                                <?php endif; ?>
                                <?php if(Route::has('maintenance.requests.index')): ?>
                                    <a class="dropdown-item" href="<?php echo e(route('maintenance.requests.index')); ?>"><i class="fas fa-list me-2"></i> All Requests</a>
                                <?php endif; ?>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('assign-work-orders')): ?>
                                    ...
                                    <?php if(Route::has('maintenance.work-orders.index')): ?>
                                        <a class="dropdown-item" href="<?php echo e(route('maintenance.work-orders.index')); ?>"><i class="fas fa-clipboard-check me-2"></i> Work Orders</a>
                                    <?php endif; ?>
                                    <?php if(Route::has('maintenance.work-orders.create')): ?>
                                        <a class="dropdown-item" href="<?php echo e(route('maintenance.work-orders.create')); ?>"><i class="fas fa-plus-circle me-2"></i> Create WO</a>
                                    <?php endif; ?>
                                <?php endif; ?>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage-equipment')): ?>
                                    ...
                                    <?php if(Route::has('maintenance.equipment.index')): ?>
                                        <a class="dropdown-item" href="<?php echo e(route('maintenance.equipment.index')); ?>"><i class="fas fa-toolbox me-2"></i> Equipment Mgt</a>
                                    <?php endif; ?>
                                <?php endif; ?>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view-maintenance-reports')): ?>
                                    ...
                                    <?php if(Route::has('maintenance.reports')): ?>
                                        <a class="dropdown-item" href="<?php echo e(route('maintenance.reports')); ?>"><i class="fas fa-chart-bar me-2"></i> Reports</a>
                                    <?php endif; ?>
                                <?php endif; ?>
                            </div>
                        </li>
                        ...
                        <?php if(in_array(Auth::user()->role, ['admin', 'technical_admin', 'system_admin'])): ?>
                            <?php if(in_array(Auth::user()->role, ['admin', 'system_admin']) && Route::has('admin.users')): ?>
                                <li class="nav-item">
                                    <a class="nav-link" href="<?php echo e(route('admin.users')); ?>" data-bs-toggle="tooltip" data-bs-placement="bottom" title="User Management">
                                        <i class="fas fa-users"></i>
                                        <span class="nav-text">Users</span>
                                    </a>
                                </li>
                            <?php endif; ?>
 <?php if(in_array(Auth::user()->role, [ 'accountmanager_admin']) && Route::has('admin.customers.assign')): ?>
                            
                                <li class="nav-item">
                                    <a class="nav-link" href="<?php echo e(route('admin.customers.assign')); ?>" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Assign Customers to Managers">
                            ...
                            <?php if(Route::has('admin.design-requests.index')): ?>
                                <li class="nav-item">
                                    <a class="nav-link" href="<?php echo e(route('admin.design-requests.index')); ?>" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Design Requests & Tickets">
                                        <i class="fas fa-drafting-compass"></i>
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle" href="#" id="commercialDocsAdmin" role="button" data-bs-toggle="dropdown" aria-expanded="false" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Commercial Documents">
                                    ...
                                    <span class="badge bg-warning text-dark rounded-pill"><?php echo e($leaseCount + $quotationCount + $contractCount); ?></span>
                                </a>
                                <ul class="dropdown-menu dropdown-menu-end shadow">
                                    <?php if(Route::has('admin.leases.index')): ?>
                                        <li><a class="dropdown-item" href="<?php echo e(route('admin.leases.index')); ?>"><i class="fas fa-network-wired me-2"></i> Leases <span class="badge bg-secondary ms-2"><?php echo e($leaseCount); ?></span></a></li>
                                    <?php endif; ?>
                                    <?php if(Route::has('admin.quotations.index')): ?>
                                        <li><a class="dropdown-item" href="<?php echo e(route('admin.quotations.index')); ?>"><i class="fas fa-file-invoice-dollar me-2"></i> Quotations <span class="badge bg-secondary ms-2"><?php echo e($quotationCount); ?></span></a></li>
                                    <?php endif; ?>
                                    <?php if(Route::has('contracts.index')): ?>
                                        <li><a class="dropdown-item" href="<?php echo e(route('contracts.index')); ?>"><i class="fas fa-file-contract me-2"></i> Contracts <span class="badge bg-secondary ms-2"><?php echo e($contractCount); ?></span></a></li>
                                    <?php endif; ?>
                                    <li><hr class="dropdown-divider"></li>
                                    <?php if(Route::has('cak.dashboard')): ?>
                                        <li><a class="dropdown-item" href="<?php echo e(route('cak.dashboard')); ?>"><i class="fas fa-tachometer-alt me-2 text-warning"></i> CAK Forms</a></li>
                                    <?php endif; ?>
                                </ul>
                            </li>
                        <?php endif; ?>
                        ...
                        <?php if(Auth::user()->role === 'customer'): ?>
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo e(route('customer.profile.show')); ?>" data-bs-toggle="tooltip" data-bs-placement="bottom" title="My Profile">
    ...
    <ul class="dropdown-menu">
        <li>
            <a class="dropdown-item" href="<?php echo e(route('customer.leases.index')); ?>" title="My Leases">
                <i class="fas fa-network-wired me-2"></i>
                <span class="nav-text">Leases</span>
            </a>
        </li>
        <li>
            <a class="dropdown-item" href="<?php echo e(route('customer.contracts.index')); ?>" title="My Contracts">
                <i class="fas fa-file-contract me-2"></i>
                <span class="nav-text">Contracts</span>
            </a>
        </li>
        <li>
            <a class="dropdown-item" href="<?php echo e(route('customer.design-requests.index')); ?>" title="Design Requests">
                <i class="fas fa-drafting-compass me-2"></i>
                <span class="nav-text">Design</span>
            </a>
        </li>
        <li>
            <a class="dropdown-item" href="<?php echo e(route('customer.billings.index')); ?>" title="My Invoices">
                <i class="fas fa-file-invoice me-2"></i>
                <span class="nav-text">Invoices</span>
            </a>
        </li>
        <li>
            <a class="dropdown-item" href="<?php echo e(route('customer.documents.index')); ?>" title="My Documents">
                ...
                <span class="nav-text">Other Documents</span>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo e(route('customer.tickets')); ?>" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Support Tickets">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <?php if(Route::has('customer.certificates.conditional.index')): ?>
                                        <li><a class="dropdown-item" href="<?php echo e(route('customer.certificates.conditional.index')); ?>"><i class="fas fa-file-contract me-2"></i> Conditional Certificates</a></li>
                                    <?php endif; ?>
                                    <?php if(Route::has('customer.certificates.acceptance.index')): ?>
                                        <li><a class="dropdown-item" href="<?php echo e(route('customer.certificates.acceptance.index')); ?>"><i class="fas fa-check-circle me-2"></i> Acceptance Certificates</a></li>
                                    <?php endif; ?>
                                </ul>
                            </li>
                        <?php endif; ?>
                        ...
                        <?php if(Auth::user()->role === 'finance'): ?>
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end" style="min-width: 260px;">
                                    ...
                                    <?php if(Route::has('finance.billing.index')): ?>
                                        <li><a class="dropdown-item" href="<?php echo e(route('finance.billing.index')); ?>"><i class="fas fa-file-invoice-dollar me-2"></i> Billings</a></li>
                                    <?php endif; ?>
                                    <?php if(Route::has('finance.debt.overdue-invoices')): ?>
                                        <li><a class="dropdown-item" href="<?php echo e(route('finance.debt.overdue-invoices')); ?>"><i class="fas fa-money-check me-2"></i> Installment Plans</a></li>
                                    <?php endif; ?>
                                    <?php if(Route::has('finance.payments.index')): ?>
                                        <li><a class="dropdown-item" href="<?php echo e(route('finance.payments.index')); ?>"><i class="fas fa-money-bill-wave me-2"></i> Payment Followups</a></li>
                                    <?php endif; ?>
                                    <li><hr class="dropdown-divider"></li>
                                    <?php if(Route::has('finance.transactions.index')): ?>
                                        <li><a class="dropdown-item" href="<?php echo e(route('finance.transactions.index')); ?>"><i class="fas fa-exchange-alt me-2"></i> Transactions</a></li>
                                    <?php endif; ?>
                                    <?php if(Route::has('finance.reports')): ?>
                                        <li><a class="dropdown-item" href="<?php echo e(route('finance.reports')); ?>"><i class="fas fa-chart-bar me-2"></i> Reports</a></li>
                                    <?php endif; ?>
                                    <?php if(Route::has('finance.financial-parameters.index')): ?>
                                        <li><a class="dropdown-item" href="<?php echo e(route('finance.financial-parameters.index')); ?>"><i class="fas fa-cog me-2"></i> Parameters</a></li>
                                    <?php endif; ?>
                                </ul>
                            </li>
                            ...
                            <?php if(Route::has('finance.payments.index')): ?>
                                <li class="nav-item">
                                    <a class="nav-link" href="<?php echo e(route('finance.payments.index')); ?>" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Payment Management">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end shadow">
                                    <?php if(Route::has('admin.leases.index')): ?>
                                        <li><a class="dropdown-item" href="<?php echo e(route('admin.leases.index')); ?>"><i class="fas fa-network-wired me-2"></i> Leases</a></li>
                                    <?php endif; ?>
                                    <?php if(Route::has('admin.quotations.index')): ?>
                                        <li><a class="dropdown-item" href="<?php echo e(route('admin.quotations.index')); ?>"><i class="fas fa-file-invoice-dollar me-2"></i> Quotations</a></li>
                                    <?php endif; ?>
                                    <?php if(Route::has('contracts.index')): ?>
                                        <li><a class="dropdown-item" href="<?php echo e(route('contracts.index')); ?>"><i class="fas fa-file-contract me-2"></i> Contracts</a></li>
                                    <?php endif; ?>
                                    <li><hr class="dropdown-divider"></li>
                                    <?php if(Route::has('cak.dashboard')): ?>
                                        <li><a class="dropdown-item" href="<?php echo e(route('cak.dashboard')); ?>"><i class="fas fa-tachometer-alt me-2"></i> CAK Forms</a></li>
                                    <?php endif; ?>
                                </ul>
                            </li>
                        <?php endif; ?>
                        ...
                        <?php if(Auth::user()->role === 'designer'): ?>
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo e(route('designer.requests.index')); ?>" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Design Requests">
                                    <i class="fas fa-drafting-compass"></i>
                                    <span class="nav-text">Design Req</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo e(route('designer.quotations.index')); ?>" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Quotations">
                        ...
                        <?php if(Auth::user()->role === 'surveyor'): ?>
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo e(route('surveyor.assignments.index')); ?>" data-bs-toggle="tooltip" data-bs-placement="bottom" title="My Assignments">
                                    <i class="fas fa-tasks"></i>
                                    <span class="nav-text">Assignments</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo e(route('surveyor.routes.index')); ?>" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Survey Routes">
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('isTechnician')): ?>
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo e(route('technician.work-orders.index')); ?>" data-bs-toggle="tooltip" data-bs-placement="bottom" title="My Work Orders">
                                    <i class="fas fa-clipboard-list"></i>
                                    <span class="nav-text">Work Orders</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo e(route('technician.equipment.index')); ?>" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Equipment Management">
                        ...
                        <?php if(Auth::user()->role === 'account_manager'): ?>
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo e(route('account-manager.customers.index')); ?>" data-bs-toggle="tooltip" data-bs-placement="bottom" title="My Customers">
                                    <i class="fas fa-users"></i>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo e(route('account-manager.tickets.index')); ?>" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Support Tickets">
                                    <i class="fas fa-ticket-alt"></i>
                                    <span class="nav-text">Tickets</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo e(route('account-manager.payments.index')); ?>" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Payment Followups">
                                    <i class="fas fa-money-bill-wave"></i>
                                    <span class="nav-text">Payments</span>
                                </a>
                            </li>
                        ...
                        <?php if(Auth::user()->role === 'debt_manager'): ?>
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo e(route('finance.debt.dashboard')); ?>" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Debt Dashboard">
                                    <i class="fas fa-chart-line"></i>
                                    <span class="nav-text">Debt Dashboard</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo e(route('finance.debt.customers')); ?>" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Customer Management">
                                    <i class="fas fa-users"></i>
                                    <span class="nav-text">Customers</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo e(route('finance.payments.index')); ?>" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Payment Tracking">
                                    <i class="fas fa-money-bill-wave"></i>
                                    <span class="nav-text">Payments</span>
                                </a>
                            </li>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end shadow-sm">
                                    <?php if(Route::has('marketing-admin.dashboard')): ?>
                                        <li><a class="dropdown-item" href="<?php echo e(route('marketing-admin.dashboard')); ?>"><i class="fas fa-tachometer-alt me-2"></i> Dashboard</a></li>
                                    <?php endif; ?>
                                    <?php if(Route::has('marketing-admin.analytics')): ?>
                                        <li><a class="dropdown-item" href="<?php echo e(route('marketing-admin.analytics')); ?>"><i class="fas fa-chart-bar me-2"></i> Performance</a></li>
                                    <?php endif; ?>
                                    <?php if(Route::has('marketing-admin.campaigns')): ?>
                                        <li><a class="dropdown-item" href="<?php echo e(route('marketing-admin.campaigns')); ?>"><i class="fas fa-bullhorn me-2"></i> Campaigns</a></li>
                                    <?php endif; ?>
                                    <?php if(Route::has('marketing-admin.reports')): ?>
                                        <li><a class="dropdown-item" href="<?php echo e(route('marketing-admin.reports')); ?>"><i class="fas fa-file-alt me-2"></i> Reports</a></li>
                                    <?php endif; ?>
                                </ul>
                            </li>
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end shadow-sm">
                                    <li><a class="dropdown-item" href="<?php echo e(route('admin.account-managers.index') ?? '#'); ?>"><i class="fas fa-user-tie me-2"></i> Account Managers</a></li>
                                    <li><a class="dropdown-item" href="<?php echo e(route('admin.customers.index') ?? '#'); ?>"><i class="fas fa-exchange-alt me-2"></i> Assign Managers</a></li>
                                    <li><hr class="dropdown-divider"></li>
                                    <li><a class="dropdown-item" href="<?php echo e(route('marketing-admin.performance') ?? '#'); ?>"><i class="fas fa-tachometer-alt me-2"></i> Performance</a></li>
                                    <li><a class="dropdown-item" href="<?php echo e(route('marketing-admin.sales-pipeline') ?? '#'); ?>"><i class="fas fa-funnel-dollar me-2"></i> Sales Pipeline</a></li>
                                    <li><a class="dropdown-item" href="<?php echo e(route('marketing-admin.targets') ?? '#'); ?>"><i class="fas fa-crosshairs me-2"></i> Sales Targets</a></li>
                                    <li><a class="dropdown-item" href="<?php echo e(route('marketing-admin.commissions') ?? '#'); ?>"><i class="fas fa-coins me-2"></i> Commissions</a></li>
                                </ul>
                            </li>
                            <li class="nav-item dropdown">
                        ...
                        <?php if(!in_array(Auth::user()->role, ['customer']) && Route::has('kenya.fibre.dashboard')): ?>
                            <li class="nav-item">
                                <a class="nav-link kenya-fibre-link" href="<?php echo e(route('kenya.fibre.dashboard')); ?>" data-bs-toggle="tooltip" data-bs-placement="bottom" title="GIS Map - Fibre Infrastructure">
                        ...
                        <?php if((Auth::user()->role === 'customer' && Route::has('customer.statements')) || Route::has('statements.index')): ?>
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo e(Auth::user()->role === 'customer' ? route('customer.statements') : route('statements.index')); ?>" data-bs-toggle="tooltip" data-bs-placement="bottom" title="<?php echo e(Auth::user()->role === 'customer' ? 'My Account Statements' : 'Generate Statements'); ?>">
                                    <i class="fas fa-file-invoice"></i>
                                    <span class="nav-text"><?php echo e(Auth::user()->role === 'customer' ? 'Statements' : 'Gen Stmts'); ?></span>
                                </a>
                            </li>
                        <?php endif; ?>
                        ...
                        <?php if(in_array(Auth::user()->role, ['executive', 'management', 'admin', 'system_admin'])): ?>
                            <li class="nav-item">
                                <a href="<?php echo e(route('executive.role.dashboard')); ?>" class="nav-link <?php echo e(request()->routeIs('executive.role.dashboard') ? 'active' : ''); ?>" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Executive Role Dashboard">
                                    <i class="fas fa-user-tie"></i>
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('use-chat')): ?>
                            <?php if(Route::has('chat.index')): ?>
                                <li class="nav-item">
                                    <a class="nav-link position-relative" href="<?php echo e(route('chat.index')); ?>" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Team Chat">
                                        <i class="fas fa-comments"></i>
                                        <span class="nav-text">Chat</span>
                                        <?php $unreadCount = auth()->user()->totalUnreadMessages(); ?>
                                        <?php if($unreadCount > 0): ?>
                                            <span class="badge bg-danger"><?php echo e($unreadCount > 99 ? '99+' : $unreadCount); ?></span>
                                        <?php endif; ?>
                                    </a>
                                </li>
                            <?php endif; ?>
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle position-relative" href="#" id="notificationDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Notifications">
                                ...
                                <?php if($unreadNotificationsCount > 0): ?>
                                    <span class="badge bg-danger notification-badge"><?php echo e($unreadNotificationsCount > 99 ? '99+' : $unreadNotificationsCount); ?></span>
                                <?php endif; ?>
                            </a>
                                    ...
                                    <?php $__empty_1 = true; $__currentLoopData = auth()->user()->notifications()->latest()->take(10)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        ...
                                        <li class="dropdown-item-text notification-item <?php echo e($isUnread ? 'unread' : 'read'); ?>" data-id="<?php echo e($notification->id); ?>">
                                            <div class="d-flex align-items-start gap-2">
                                                <div class="avatar-sm"><i class="fas <?php echo e($isCertificateNotification ? 'fa-file-contract' : 'fa-bell'); ?>"></i></div>
                                                <div class="flex-grow-1">
                                                    <div class="d-flex justify-content-between">
                                                        <small class="fw-bold <?php echo e($isUnread ? 'text-dark' : 'text-secondary'); ?>"><?php echo e($data['sender_name'] ?? ($isCertificateNotification ? 'ICT Engineer' : 'System')); ?></small>
                                                    ...
                                                    <small class="d-block <?php echo e($isUnread ? 'text-dark' : 'text-muted'); ?>">
                                                        <?php if($isCertificateNotification): ?>
                                                            <strong>Conditional Certificate Issued</strong><br><?php echo e($data['message_preview'] ?? $data['message']); ?>
                                                    ...
                                                    <div class="mt-2 d-flex gap-2">
                                                        <?php if($isCertificateNotification && isset($data['action_url'])): ?>
                                                            <a href="<?php echo e($data['action_url']); ?>" class="small text-kp-blue text-decoration-none"><i class="fas fa-eye"></i> View</a>
                                                        <?php endif; ?>
                                                        <?php if($isUnread): ?>
                                                            <a href="#" onclick="event.preventDefault(); markSingleNotificationRead('<?php echo e($notification->id); ?>')" class="small text-kp-green text-decoration-none"><i class="fas fa-check-circle"></i> Mark Read</a>
                                                        <?php else: ?>
                                ...
                                <?php if(auth()->user()->notifications()->count() > 0): ?>
                                    ...
                                    <li class="text-center p-2">
                                        <?php if(Route::has('designer.notifications')): ?>
                                            <a href="<?php echo e(route('designer.notifications')); ?>" class="btn btn-sm btn-outline-kp-primary w-100"><i class="fas fa-list"></i> View All</a>
                                        <?php endif; ?>
                                    </li>
                                <?php endif; ?>
                            </ul>
                ...
                <ul class="navbar-nav ms-auto">
                    <?php if(auth()->guard()->check()): ?>
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle d-flex align-items-center" href="#" id="userMenuDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false" data-bs-toggle="tooltip" data-bs-placement="bottom" title="<?php echo e(Auth::user()->name); ?> (<?php echo e(ucfirst(str_replace('_', ' ', Auth::user()->role))); ?>)">
                                <i class="fas fa-user-circle fa-lg"></i>
                                <span class="nav-text d-none">Profile</span>
                                <span class="badge bg-<?php echo e(Auth::user()->role === 'admin' ? 'danger' : (Auth::user()->role === 'technical_admin' ? 'warning' : (Auth::user()->role === 'system_admin' ? 'primary' : (Auth::user()->role === 'accountmanager_admin' ? 'info' : (Auth::user()->role === 'technician' ? 'warning' : (Auth::user()->role === 'debt_manager' ? 'info' : (Auth::user()->role === 'account_manager' ? 'info' : 'secondary'))))))); ?> ms-1 d-none"><?php echo e(ucfirst(str_replace('_', ' ', Auth::user()->role))); ?></span>
                            </a>
                            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="userMenuDropdown">
                                <li class="dropdown-header"><small>Logged in as</small><br><strong class="text-break"><?php echo e(Auth::user()->email); ?></strong></li>
                                <li><hr class="dropdown-divider"></li>
                                <li>
                    ...
                    <?php else: ?>
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(route('login')); ?>" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Login">
                        ...
                        <?php if(Route::has('register.customer')): ?>
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo e(route('register.customer')); ?>" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Register New Account">
            ...
            <div class="row align-items-center g-2 g-sm-3">
                        ...
                        <div class="col-6 col-sm-3">
                            ...
                            <ul class="list-unstyled footer-links mb-0">
                                ...
                                <?php if(Route::has('help.index')): ?>
                                    <li class="mb-1"><a href="<?php echo e(route('help.index')); ?>" class="footer-link small">Help</a></li>
                                <?php endif; ?>
                            </ul>
                        </div>
                        <div class="col-6 col-sm-3">
                ...
                <div class="col-lg-3">
                    ...
                    <div class="footer-meta d-flex flex-wrap justify-content-lg-end gap-1 small">
                        <span class="badge px-2 py-1" style="background: linear-gradient(135deg, var(--kp-blue), var(--kp-green)); color: white;">v<?php echo e(config('app.version', '1.0.0')); ?></span>
            ...
            <div class="row align-items-center">
                <div class="col-md-6 mb-2 mb-md-0">
                    <div class="copyright small">
                        <p class="mb-0 text-light opacity-75">&copy; <?php echo e(date('Y')); ?> <strong style="color: var(--kp-yellow);">Kenya Power</strong>. All rights reserved.</p>
                    </div>
                </div>
                <div class="col-md-6">
