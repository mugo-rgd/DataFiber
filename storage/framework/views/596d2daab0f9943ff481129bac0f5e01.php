<?php $__env->startSection('title', 'PreSale Engineer Dashboard'); ?>
                ...
                <div class="col-12 col-lg-8 mb-2 mb-lg-0">
                    ...
                    <div class="d-flex flex-wrap align-items-center gap-1 gap-sm-2 mt-2">
                        <span class="badge bg-white text-primary responsive-badge">
                            <i class="fas fa-user me-1"></i> <span class="name-text"><?php echo e(Str::limit(Auth::user()->name, 15)); ?></span>
                        </span>
                        <span class="badge bg-white-20 text-white responsive-badge">
                            <i class="fas fa-calendar me-1"></i> <span class="date-text"><?php echo e(now()->format('M d, Y')); ?></span>
                        </span>
                    </div>
                </div>
                    ...
                    <div class="stat-card-body p-2 p-sm-3 p-md-4">
                        <div class="d-flex justify-content-between align-items-start mb-2 mb-sm-3 mb-md-4">
                            <div class="stat-icon bg-<?php echo e($stat['color']); ?>-light rounded-circle responsive-stat-icon">
                                <i class="fas fa-<?php echo e($stat['icon']); ?> text-<?php echo e($stat['color']); ?>"></i>
                            </div>
                            <div class="trend-indicator">
                                <span class="badge bg-<?php echo e($stat['badge_color']); ?> responsive-badge"><?php echo e($stat['badge']); ?></span>
                            </div>
                        </div>
                        <h6 class="stat-title text-muted text-uppercase small mb-1 mb-sm-2"><?php echo e($stat['title']); ?></h6>
                        <div class="stat-value fw-bold text-dark responsive-stat-value"><?php echo e($stat['value']); ?></div>
                        <div class="stat-subtitle">
                            <small class="text-muted responsive-text"><?php echo e($stat['subtitle']); ?></small>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-6 col-md-6 col-lg-3">
                <div class="card border h-100">
                    <div class="card-body text-center p-2 p-sm-3">
                        <div class="text-<?php echo e($metric['color']); ?> mb-1 mb-sm-2">
                            <i class="fas fa-<?php echo e($metric['icon']); ?> responsive-metric-icon"></i>
                        </div>
                        <div class="responsive-metric-value fw-bold mb-1"><?php echo e($metric['value']); ?></div>
                        <small class="text-muted responsive-text"><?php echo e($metric['title']); ?></small>
                    </div>
                </div>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    ...
    'desc' => 'Assign design requests to ICT regional'
                        ...
                        <div class="row g-2 g-sm-3 g-md-4">
                            ...
                            <div class="col-6 col-sm-4 col-md-3 col-lg-2 col-xl-2 col-xxl-2">
                                ...
                                <a href="<?php echo e($link); ?>" class="action-card position-relative">
                                    <?php if($badgeCount > 0): ?>
                    ...
                    <div class="card-header bg-white border-0 py-2 py-sm-3">
                        <div class="d-flex justify-content-between align-items-center flex-wrap">
                            ...
                            <div class="d-flex align-items-center mt-1 mt-sm-0">
                                <span class="badge bg-light text-dark responsive-badge d-none d-sm-inline"><?php echo e($recentRequests->count()); ?> requests</span>
                                <a href="<?php echo e(route('designer.requests.index')); ?>" class="btn btn-sm btn-primary ms-1 ms-sm-2 responsive-btn">
                    ...
                    <div class="card-body p-0">
                            ...
                            <table class="table table-hover mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr class="border-bottom">
                                        <td class="fw-bold">#<?php echo e($request->request_number); ?></td>
                                        <td class="d-none d-md-table-cell">
                                            <div class="d-flex align-items-center">
                                                <div class="customer-avatar me-2">
                                                    <i class="fas fa-user text-primary responsive-icon-sm"></i>
                                                </div>
                                                <div class="responsive-text"><?php echo e($request->customer->name ?? 'N/A'); ?></div>
                                            </div>
                                        </td>
                                        <td class="responsive-text"><?php echo e(Str::limit($request->title, 30)); ?></td>
                                        <td class="d-none d-sm-table-cell">
                                            ...
                                            ?>
                                            <span class="badge bg-<?php echo e($color); ?> responsive-badge">
                                                <?php echo e($text); ?>
                                        ...
                                        <td class="d-none d-lg-table-cell">
                                            <div class="d-flex flex-column">
                                                <span class="text-muted responsive-text-sm"><?php echo e($request->created_at->format('M d, Y')); ?></span>
                                                <span class="small text-muted responsive-text-sm"><?php echo e($request->created_at->diffForHumans()); ?></span>
                                            </div>
                                        </td>
                                        <td class="text-center">
                                            <div class="btn-group btn-group-sm responsive-btn-group" role="group">
                                                <!-- Always show View Details button -->
                                                <a href="<?php echo e(route('designer.requests.show', $request)); ?>"
                                                ...
                                                <?php if(in_array(strtolower($request->status), ['assigned', 'pending'])): ?>
                                                <a href="<?php echo e(route('designer.requests.show', $request)); ?>"
                                                ...
                                                <?php if(strtolower($request->status) === 'designed'): ?>
                                                    <?php if(Route::has('designer.quotations.create')): ?>
                                                    <a href="<?php echo e(route('designer.quotations.create', ['designRequest' => $request])); ?>"
                                            ...
                                            <div class="dropdown d-md-none">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li><a class="dropdown-item" href="<?php echo e(route('designer.requests.show', $request)); ?>">View Details</a></li>
                                                    <?php if(in_array(strtolower($request->status), ['assigned', 'pending'])): ?>
                                                    <li><a class="dropdown-item" href="<?php echo e(route('designer.requests.show', $request)); ?>">Edit Design</a></li>
                                                    <?php endif; ?>
                                                    <?php if(strtolower($request->status) === 'designed' && Route::has('designer.quotations.create')): ?>
                                                    <li><a class="dropdown-item" href="<?php echo e(route('designer.quotations.create', ['designRequest' => $request])); ?>">Create Quotation</a></li>
                                                    <?php endif; ?>
                                                </ul>
                                            </div>
                                        </td>
                        ...
                        <div class="text-center py-4 py-sm-5">
                            <div class="empty-state">
                                ...
                                <a href="<?php echo e(route('designer.requests.index')); ?>" class="btn btn-primary responsive-btn">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH G:\project\darkfibre-crm\resources\views/designer/dashboard.blade.php ENDPATH**/ ?>